...
pub async fn users_get_me(configuration: &configuration::Configuration, ) -> Result<models::UserPrivate, Error<UsersGetMeError>> {
...
pub async fn users_login(configuration: &configuration::Configuration, login_data: models::LoginData) -> Result<models::OnlineResponse, Error<UsersLoginError>> {
...
pub async fn users_online(configuration: &configuration::Configuration, username: Option<&str>) -> Result<models::OnlineResponse, Error<UsersOnlineError>> {
    // add a prefix to parameters to efficiently prevent name collisions
